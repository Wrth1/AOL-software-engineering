...
class NotesListPage extends StatefulWidget {
  ...
  const NotesListPage(
      {super.key, required this.notes, required this.editingIndex});
    ...
    return Scaffold(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  padding: const EdgeInsets.symmetric(
                      vertical: 8.0,
                      horizontal:
                          16.0), // Menambahkan padding vertikal dan horizontal
                  child: ListTile(
                    title: Padding(
                      padding: const EdgeInsets.only(
                          right: 16.0), // Menambahkan padding kanan untuk teks
                      child: QuillEditor.basic(
                        configurations: QuillEditorConfigurations(
                          controller: QuillController(
                            keepStyleOnNewLine: false,
                            document: Document.fromJson(jsonDecode(noteValue)),
                    ...
                    trailing: Padding(
                      padding: const EdgeInsets.only(
                          left:
                              8.0), // Menambahkan padding kiri untuk ikon sampah
                      child: IconButton(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: SafeArea(
          child: Row(
            mainAxisAlignment:
                MainAxisAlignment.center, // Membuat ikon berjarak
            children: [
              IconButton(
                icon: const Icon(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: const Text(
                'Delete',
                style: TextStyle(
                    color: Color.fromARGB(255, 254, 43, 43),
                    fontWeight: FontWeight.bold),
              ),
            ),
          ],
